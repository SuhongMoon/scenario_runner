...
# TODO
# 1. Add right/left cams DONE
# 2. Fix weather, map and vehicle (which weather, map and vehicle?) DONE
# 3. Making saver which saves three images from three cameras and control signals (Refer to Yang's data) DOING
# 4. Remove other sensors and fix cam positions DONE
